...
type NodeStatus struct {
	...
	// see http://releases.k8s.io/v1.0.1/docs/resources.md for more details.
	Capacity ResourceList `json:"capacity,omitempty" description:"compute resource capacity of the node; http://releases.k8s.io/v1.0.1/docs/resources.md"`
